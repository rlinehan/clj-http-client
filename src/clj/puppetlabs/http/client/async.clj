...
(schema/defn ^:always-validate get-client-metrics :- (schema/maybe common/Metrics)
  ...
  ([metric-registry :- common/OptionalMetricRegistry
   ...
   (when metric-registry
     (cond
       (:verb metric-filter) (into {} (Metrics/getClientMetricsWithUrlAndVerb metric-registry (:url metric-filter) (:verb metric-filter) Metrics$MetricType/BYTES_READ))
       (:url metric-filter) (into {} (Metrics/getClientMetricsWithUrl metric-registry (:url metric-filter) Metrics$MetricType/BYTES_READ))
       (:metric-id metric-filter) (into {} (Metrics/getClientMetricsWithMetricId metric-registry (into-array (:metric-id metric-filter)) Metrics$MetricType/BYTES_READ))
