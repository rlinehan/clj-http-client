        ...
        (with-open [client (Sync/createClient (ClientOptions.) metric-registry)]
          ...
          (let [short-response (.get client short-request-opts)
            ...
            (let [client-metrics (.getClientMetrics client)
                  ...
                  short-id "puppetlabs.http-client.experimental.http://localhost:10000/short.GET"
                  long-id "puppetlabs.http-client.experimental.http://localhost:10000/long.GET"]
              ...
              (testing ".getClientMetrics returns a map of metric name to timer instance"
                (is (= (set (list "puppetlabs.http-client.experimental.http://localhost:10000/hello.GET"
                                  short-id long-id))
